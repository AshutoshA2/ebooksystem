<div class="container-fluid bg-color mt-1 p-2"
     style="background-color: #303f9f;">
    <p class="text-center text-white p3"> <p>
</div>
<!-- Footer -->
<style>
    @charset "UTF-8";
        ...
        <div class="footer-grid">
            <div>
                ...
                <p class="footer-description">
                    Transforming academic into success through comprehensive e-learning solutions.
                </p>
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li cla<div class="container-fluid bg-color mt-1 p-2"
     style="background-color: #303f9f;">
    <p class="text-center text-white p3"> <p>
</div>
<!-- Footer -->
        ...
        <div class="footer-grid">
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li class="footer-link"><a href="tel:+919876543210">9862138804</a></li>
...
ss="footer-link"><a href="#">Contact</a></li>
                </ul>
            </div>
